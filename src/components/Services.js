    ...
    <section>
      <div className="pt-32">
        <div className="px-5 md:max-w-7xl  md:mx-auto md:px-5">
          ...
          <div className=" text-center grid grid-cols-1 gap-5 py-12 md:grid-cols-4 md:gap-5 md:text-left">
            <div className="bg-white h-content py-5 text-gray text-center rounded-xl shadow-lg cursor-pointer relative transition-all duration-500 hover:bg-bright hover:text-white">
              <div className="bg-bright w-20 h-20 rounded-full mx-auto mb-2 flex justify-center items-center z-20">
                <svg
                  width="35"
                  height="33"
               viewBox="0 0 35 33"
              ...
              <div>
                <h4 className="text-lg leading-8 font-bold mb-3">
                  User Research
                </h4>
                <p className="mb-10 mt-5 mx-5 ">
            ...
            <div className="bg-white h-content py-5 text-h-1 text-center rounded-xl shadow-lg cursor-pointer relative transition-all duration-500 hover:bg-bright hover:text-white">
              <div className="bg-bright w-20 h-20 rounded-full mx-auto mb-2 flex justify-center items-center z-20">
